...
1.
  * How many rows were returned: `7 not counting null`
...
3.
  * How many rows were returned: `6 not counting null`
...
`I believe it would be ALOT easier using mySQL due to its ability to search massive fields of data and retreiving only what you need`
